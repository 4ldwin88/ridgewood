...
The subsequent migration-recovery slice replaced the incomplete active chain with all 126 hosted migrations and their actual timestamps, including document-table migration 20260902201253. The prior files are archived outside execution. Full clean Supabase replay and all 17 document contract/guard checks passed; see migration-recovery.md.
