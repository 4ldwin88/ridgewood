...
begin
  ...
  insert into public.project_state_stage_requirements
    (project_state_id, stage, requirement_key, label, required, status, notes)
  values
    (ps.id, 'authorization', 'predevelopment_readiness', 'Predevelopment readiness confirmed', true, 'satisfied', 'All seven Predevelopment domains are satisfied or not applicable at Authorization entry.')
