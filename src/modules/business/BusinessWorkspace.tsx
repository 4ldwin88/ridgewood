...
const qualification: [QualificationArea, string, string][] = [
  ['fit', 'Fit', 'Does this work fit Ridgewood’s strategy and capabilities?'],
  ['stakeholders', 'Client / partner', 'Do we understand who is involved and who can make decisions?'],
  ['site', 'Site', 'Do we understand the site or location well enough to proceed?'],
  ['commercial', 'Commercial', 'Is there a credible commercial path worth investigating?'],
];
