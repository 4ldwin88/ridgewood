      ...
      <main id="top">
        ...
        <section className="public-capability-band" aria-label="Ridgewood capabilities">
          <div className="public-container public-capability-band__inner">
            {['Residential Development', 'Custom Construction', 'Renovation', 'Commercial Interiors', 'Project Management'].map((item) => <span key={item}>{item}</span>)}
          </div>
        </section>

        <section id="construction" className="public-section public-copy-section">
          <div className="public-container public-copy-grid"><div><p className="public-eyebrow">Construction</p><h2>Experience at the site. Accountability through delivery.</h2></div><p>From ground-up residential work and substantial renovations to commercial interiors and complex completion, Ridgewood coordinates the people, information and execution required to move projects forward.</p></div>
        </section>

        <section id="development" className="public-section public-copy-section public-copy-section--alt">
          <div className="public-container public-copy-grid"><div><p className="public-eyebrow">Development</p><h2>Construction knowledge applied earlier.</h2></div><p>Ridgewood brings practical delivery experience upstream—evaluating opportunities, structuring project-specific teams and managing the path from concept toward a completed asset.</p></div>
        </section>

        <section id="work" className="public-section public-work">
          <div className="public-container">
            <div className="public-section-heading"><div><p className="public-eyebrow">Selected work</p><h2>Experience across building, renovation and development.</h2></div><p>Project names and addresses are withheld from this public concept until publication approval is confirmed. Authentic project media will replace placeholders after archive recovery.</p></div>
            <div className="public-project-strip" role="list" aria-label="Selected project types">
              {projectTypes.map((type) => <article className="public-project-slide" role="listitem" key={type}><div className="public-project-slide__placeholder" aria-hidden="true"/><div className="public-project-slide__overlay"><span>Selected work</span><h3>{type}</h3></div></article>)}
            </div>
          </div>
        </section>

        <section className="public-section public-process" aria-labelledby="process-title">
          <div className="public-container"><p className="public-eyebrow">How Ridgewood works</p><h2 id="process-title">Clarity before construction. Ownership through completion.</h2><div className="public-process__grid">{[['01','Understand','Define the opportunity, constraints, scope and commercial reality before momentum creates avoidable risk.'],['02','Plan','Assemble the right team, coordinate preconstruction, establish priorities and create a practical delivery strategy.'],['03','Deliver','Manage construction, decisions, quality, schedule and closeout with clear ownership and visible next actions.']].map(([n,t,c]) => <article key={n}><span>{n}</span><h3>{t}</h3><p>{c}</p></article>)}</div></div>
        </section>

        <section id="about" className="public-section public-founder">
          <div className="public-container public-founder__grid"><div className="public-founder__placeholder" aria-hidden="true"/><div className="public-founder__copy"><p className="public-eyebrow">About us</p><h2>Built from the work outward.</h2><p>Ridgewood is led by Edward Nguyễn, whose experience spans hands-on construction, custom residential work, redevelopment, renovation, commercial interiors and project management. The company's next chapter is focused on stronger construction management, development and strategic project partnerships.</p><p className="public-small-note">Founder imagery and final biography language remain subject to publication approval.</p></div></div>
        </section>

        <section id="contact" className="public-opportunity">
          <div className="public-container public-opportunity__inner"><p className="public-eyebrow">Contact us</p><h2>Have a project, property or opportunity worth discussing?</h2><p>Start with the type of conversation that fits.</p><div className="public-actions"><a className="public-button public-button--light" href="mailto:info@ridgewoodgroup.ca?subject=Construction%20Project%20Inquiry">Construction project</a><a className="public-button public-button--outline-light" href="mailto:info@ridgewoodgroup.ca?subject=Development%20Opportunity">Development opportunity</a></div></div>
        </section>
      </main>
