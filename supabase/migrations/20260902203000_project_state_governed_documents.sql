-- Recovered verbatim SQL from Ridgewood remote migration 20260902201253.
-- Repository timestamp is historical and differs from remote. Do not replay
-- this migration on the existing hosted database or claim full chain parity.
