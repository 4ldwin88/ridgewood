...
security invoker
set search_path = ''
as $$ select private.update_project_state_opportunity_basics_command(project_state_input, basics_input) $$;
...
security invoker
set search_path = ''
as $$ select private.advance_project_state_to_qualification_command(project_state_input) $$;
