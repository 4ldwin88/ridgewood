...
as $$ select private.set_project_state_qualification_decision_command(project_state_input,decision_input,rationale_input); $$;
...
returns public.project_states language sql security invoker set search_path = ''
as $$ select private.resume_held_project_state_command(project_state_input); $$;
...
returns public.project_states language sql security invoker set search_path = ''
as $$ select private.archive_project_state_command(project_state_input); $$;
