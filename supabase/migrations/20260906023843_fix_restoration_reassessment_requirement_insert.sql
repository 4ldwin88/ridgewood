...
begin
 ...
 insert into public.project_state_stage_requirements(id,project_state_id,stage,requirement_key,label,status,required,notes,updated_by,updated_at,gate_key)
 values(gen_random_uuid(),ps.id,ps.stage,'restoration_reassessment','Restoration reassessment','in_progress'::public.readiness_state,true,reassessment_note,uid,now(),'restoration_reassessment')
