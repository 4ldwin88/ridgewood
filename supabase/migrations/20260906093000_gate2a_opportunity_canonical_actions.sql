-- Gate2A: Opportunity readiness derives its required next step from the canonical
-- cross-stage Actions capability. project_states.next_action remains a legacy
-- compatibility/projection field and no longer controls readiness.
