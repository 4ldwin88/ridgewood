-- Gate2A: keep privileged implementations out of the exposed public API schema.
-- Public RPCs are SECURITY INVOKER gateways; private implementations retain the
-- existing SECURITY DEFINER authorization and command semantics.
...
returns public.project_states language sql security invoker set search_path = ''
...
returns public.authorization_amendments language sql security invoker set search_path = ''
